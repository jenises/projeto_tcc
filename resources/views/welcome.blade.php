                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        <div class="direct-chat-infos clearfix">
                          <span class="direct-chat-name float-start"> Jenises Rudolf </span>
                      ...
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img
                              ...
                              src={{Vite::asset('resources/images/user1-128x128.png')}}
                              alt="User Avatar"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src={{Vite::asset('resources/images/user7-128x128.png')}}
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src={{Vite::asset('resources/images/user3-128x128.png')}}
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src={{Vite::asset('resources/images/user5-128x128.png')}}
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src={{Vite::asset('resources/images/user6-128x128.png')}}
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src={{Vite::asset('resources/images/user8-128x128.png')}}
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
